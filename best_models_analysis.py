...
ax.set_xlabel('Importance Score', fontsize=20, fontfamily='Arial')
ax.set_xlim(0, 1.0)
...
# A1 XGB-only
fig, ax = plt.subplots(figsize=(10, 6))
xgb_only_df = a1_importance_df.sort_values('XGB_Importance', ascending=False)
variables_xgb = [VARIABLE_LABELS.get(v, v) for v in xgb_only_df['Variable']]
y_pos_xgb = np.arange(len(variables_xgb))
ax.barh(y_pos_xgb, xgb_only_df['XGB_Importance'].values, color=magma_cmap(0.7))
ax.set_yticks(y_pos_xgb)
ax.set_yticklabels(variables_xgb)
ax.set_xlabel('Importance Score', fontsize=20, fontfamily='Arial')
ax.set_xlim(0, 1.0)
ax.tick_params(axis='both', labelsize=16)
ax.invert_yaxis()
plt.tight_layout()
plt.savefig(output_dir / 'A1_WEEP_Importance_XGB_only.png', dpi=1000, bbox_inches='tight')
plt.close()
print("Saved: A1_WEEP_Importance_XGB_only.png")
...
# A2 XGB-only
fig, ax = plt.subplots(figsize=(10, 6))
xgb_only_df = a2_importance_df.sort_values('XGB_Importance', ascending=False)
variables_xgb = [VARIABLE_LABELS.get(v, v) for v in xgb_only_df['Variable']]
y_pos_xgb = np.arange(len(variables_xgb))
ax.barh(y_pos_xgb, xgb_only_df['XGB_Importance'].values, color=magma_cmap(0.7))
ax.set_yticks(y_pos_xgb)
...
ax.invert_yaxis()
plt.tight_layout()
plt.savefig(output_dir / 'A2_FLOOD_Importance_XGB_only.png', dpi=1000, bbox_inches='tight')
plt.close()
print("Saved: A2_FLOOD_Importance_XGB_only.png")
...
# A3 XGB-only
fig, ax = plt.subplots(figsize=(10, 6))
xgb_only_df = a3_importance_df.sort_values('XGB_Importance', ascending=False)
variables_xgb = [VARIABLE_LABELS.get(v, v) for v in xgb_only_df['Variable']]
y_pos_xgb = np.arange(len(variables_xgb))
ax.barh(y_pos_xgb, xgb_only_df['XGB_Importance'].values, color=magma_cmap(0.7))
ax.set_yticks(y_pos_xgb)
...
ax.invert_yaxis()
plt.tight_layout()
plt.savefig(output_dir / 'A3_CONV_Importance_XGB_only.png', dpi=1000, bbox_inches='tight')
plt.close()
print("Saved: A3_CONV_Importance_XGB_only.png")
...
# A4 XGB-only
fig, ax = plt.subplots(figsize=(10, 6))
xgb_only_df = a4_importance_df.sort_values('XGB_Importance', ascending=False)
variables_xgb = [VARIABLE_LABELS.get(v, v) for v in xgb_only_df['Variable']]
y_pos_xgb = np.arange(len(variables_xgb))
ax.barh(y_pos_xgb, xgb_only_df['XGB_Importance'].values, color=magma_cmap(0.7))
ax.set_yticks(y_pos_xgb)
...
ax.invert_yaxis()
plt.tight_layout()
plt.savefig(output_dir / 'A4_PURITY_Importance_XGB_only.png', dpi=1000, bbox_inches='tight')
plt.close()
print("Saved: A4_PURITY_Importance_XGB_only.png")
